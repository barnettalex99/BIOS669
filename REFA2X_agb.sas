...
/* proc printto log="/home/u63044704/BIOS699/REFA/REFA2X_agb.log"; */

ods pdf file='/home/u63044704/BIOS699/REFA/REFA2X_agb.pdf' pdftoc=2;

%LET visit=OMRA5A;
title 'Banned Medication at Visit 2';

proc print data = mets.omra_669;
	var BID OMRA1 &visit;
	where &visit = 'Y' and OMRA1 IN ('CIMETIDINE','AMILORIDE','DIGOXIN','MORPHINE','PROCAINAMIDE','QUINIDINE','QUININE','RANITIDINE','TRIAMTERENE','TRIMETHOPRIM','VANCOMYCIN','FUROSEMIDE','NIFEDIPINE');
run;

%LET visit=OMRA5D;
title 'Banned Medication at Visit 5';
...
%LET visit=OMRA5I;
title 'Banned Medication at Visit 10';
